...
if($_SERVER['REQUEST_METHOD'] == 'GET'){
    // GET method : show the data of the expense
    if(!isset($_GET["srNo"])){
    ...
    $sql = "SELECT * FROM expensedata WHERE srNo=$srNo";
    ...
    // POST method : update the data of the expense
    $srNo = $_POST["srNo"];
    $title = $_POST["title"];
    $expAmt = $_POST["expAmt"];
    ...
    do{
        ...
        $sql = "UPDATE `expensedata` SET `title` = '$title', `expDesc` = '$expDesc', `expAmt` = '$expAmt' WHERE `srNo` = $srNo";
        $result = $connection->query($sql);
    ...
    <div class="container my-5">
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-4">
                    <textarea class="form-control" name="expDesc" rows = "2"><?php echo $expDesc?></textarea>
                    <!-- <input type="textarea" class="form-control" name="expDesc" rows = "3" value="<?php echo $expDesc;?>"> -->
                </div>    
            </div>
